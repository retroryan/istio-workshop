...
1. Deploy MySQL[^1], Redis, the Hello World microservices, and the associated Kubernetes Services from the `istio-workshop` dir:
...
[^1]: NOTE: Recent versions of Istio (1.0.4, 1.0.5, 1.1.0-snapshot.3) have an issue which prevents guestbook-service connections to mysql:
