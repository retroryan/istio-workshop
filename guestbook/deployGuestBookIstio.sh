...
# Using redis as a Spring Session cache seems to be broken in istio 0.2.9
...
kubectl apply -f <(istioctl kube-inject -f $SCRIPTDIR/ui-deployment.yaml) -f $SCRIPTDIR/ui-service.yaml
